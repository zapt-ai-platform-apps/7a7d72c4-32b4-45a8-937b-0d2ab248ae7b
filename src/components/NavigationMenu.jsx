...
export default function NavigationMenu() {
  ...
  return (
    <nav class="relative" aria-label="Main Navigation">
      <div class="flex items-center justify-between p-6 bg-dark-navy dark:bg-light-gray">
        <img
      ...
      <div class={`md:hidden ${isOpen() ? 'block' : 'hidden'}`}>
        <ul
          class="absolute top-full left-0 w-full bg-dark-navy dark:bg-light-gray text-light-gray dark:text-charcoal-gray flex flex-col items-center space-y-4 py-4"
          role="menu"
        >
