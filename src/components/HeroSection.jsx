export default function HeroSection() {
  return (
    <div class="relative min-h-screen flex flex-col justify-center bg-dark-navy dark:bg-light-gray bg-[url('https://supabase.zapt.ai/storage/v1/object/public/zapt-branding/zapt_hero_background.png')] bg-cover bg-center">
      ...
      <div class="absolute bottom-6 w-full flex justify-center">
        <a href="#features" class="text-light-gray dark:text-charcoal-gray hover:text-neon-yellow dark:hover:text-purple-custom transition-colors cursor-pointer">
